    ...
    <Container>
      <section className="py-10 md:py-20">
        ...
        <p className="mb-2.5 mt-4">
          ...
          store and receive identifiers and other data on your computer, phone,
          or other devices. Additionally, other technologies, such as browser or
          device storage and unique device identifiers, serve similar purposes.
        </p>
        <p>
          On our platform, we use cookies to enhance your experience. Cookies
          help us deliver tailored services, improve website functionality, and
        ...
        <p className="mb-2.5 mt-4">
          We use cookies to enhance your experience and deliver essential
          features on our platform. These cookies help us provide functionality,
          improve performance, and offer tailored services.
        </p>
        <p>
          While you have the option to disable cookies, please note that there
          are no universal methods to do so without affecting the functionality
          and features they enable. If you are unsure about the necessity of
          certain cookies, we recommend keeping them enabled to ensure the best
        ...
        <p>
          ...
          functionality of this website and others you visit. Certain features
          and services rely on cookies to function properly, and turning them
          off may result in a less optimal browsing experience. For the best
          experience, we recommend keeping cookies enabled.
        </p>
        ...
        <p className="my-4">
          ...
          enhance your experience on our site. Below are the types of
        ...
        <ul className="ml-5 list-disc">
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              We use Google Analytics, one of the most trusted analytics tools
              on the web, to understand how users interact with our site and
              identify areas for improvement. These cookies may track metrics
              like the time spent on the site, pages visited, and user behavior
          ...
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              ...
              LinkedIn, etc.) may set cookies through our site. These cookies
              can be used to enhance your profile on those platforms or
              contribute to their data collection as per their privacy policies.
            </p>
          </li>
        </ul>
