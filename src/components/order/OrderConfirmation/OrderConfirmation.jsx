        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-gray-200 bg-white px-5 py-3.5">
            ...
            <p className="text-[12px] leading-relaxed text-gray-600">
              Your payment is being reviewed by our team. You&apos;ll be
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            ...
            <Card icon={Receipt} title="Invoice">
              ...
              <Row
                label="Method"
                value={formatMethod(invoice?.payment_method)}
              />
              <Row
                label="Status"
                value={
            ...
            {isBank && manual ? (
              <Card icon={Building2} title="Transfer details">
                ...
                <Row
                  label="Paid at"
                  value={formatDateTime(manual.payment_at)}
                />
              </Card>
            ) : (
            ...
            <Card icon={Package} title="Plan details">
              ...
              <Row
                label="Products"
                value={pkg.product_limit?.toLocaleString()}
              />
