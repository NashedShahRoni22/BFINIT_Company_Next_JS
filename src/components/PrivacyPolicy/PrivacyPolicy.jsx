    ...
    <Container>
      <section className="py-10 md:py-20">
        ...
        <p className="mb-20 text-center">
          Below are the details regarding how we protect and manage your
          personal information.
        </p>

        <h2 className="text-xl font-semibold">Introduction</h2>
        <p className="mb-2.5 mt-4">
          Welcome to our website and platform. This Privacy Policy outlines how
          we collect, use, disclose, and protect your personal information when
          you access our website and use our services. Your privacy and the
          security of your personal data are our top priorities, and we are
          dedicated to maintaining the confidentiality and integrity of the
        ...
        <ul className="ml-5 mt-4 list-disc">
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              ...
              contact details, and any other information you provide
              voluntarily.
            </p>
          </li>
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              ...
              to our website, including your IP address, device information,
              browser type, and pages visited. This data is collected to improve
              our website’s functionality and to better understand how visitors
          ...
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              ...
              your preferences and recognize you when you return to our site.
        ...
        <ul className="ml-5 mt-4 list-disc">
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              We use your personal information to deliver our services,
              including any specialized offerings such as assessments, testing,
        ...
        <ul className="ml-5 mt-4 list-disc">
          <li>
            ...
            <p className="w-full max-w-3xl text-sm">
              ...
              as hosting, data analysis, and customer support. These providers
              are contractually obligated to protect your data and can only use
              it for the specified purposes.
            </p>
          </li>
          <li>
        ...
        <p className="mb-2.5 mt-4">
          ...
          our practices or legal requirements. We will post the updated version
          on our website with the revised effective date.
        </p>
